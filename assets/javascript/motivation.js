...
var motivation = [
    ...
    "You know, you can try and plan as much as you want, but you get there on game day and you get thrown a curveball, I guess, hey, the game plan goes out the window. You've got to adapt.",
    ...
    "You can only fool reality until the truth come knocking on your door.",
    ...
    "World domination.",
    "Because I'm willing to sacrifice right now. I told myself that my 20s would be sacrificed for work and the 30s I was going to chill out, but I was like no. I still got things to do. I can't let up off the gas.",
    ...
    "I used to run myself into the ground, 'til pure exhaustion. Just because then I'd feel like I deserve it. That's probably why I go so hard in the gym, go so hard in life." 
];
